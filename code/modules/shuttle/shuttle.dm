...
/obj/docking_port/stationary/proc/load_roundstart()
	if(json_key)
		...
		if(!roundstart_template)
			//CRASH("json_key:[json_key] value \[[sid]\] resulted in a null shuttle template for [src]") //TODO: FIX KILO SPAWN
			stack_trace("json_key:[json_key] value \[[sid]\] resulted in a null shuttle template for [src]")
