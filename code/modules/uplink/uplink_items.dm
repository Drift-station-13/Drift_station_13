...
/datum/uplink_item/ammo/revolver
	...
	desc = "A speed loader that contains seven additional .357 Magnum rounds; usable with the Syndicate revolver, and can be further reloaded with individual bullets. \
