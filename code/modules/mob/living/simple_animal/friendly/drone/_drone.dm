...
/mob/living/simple_animal/drone
	name = "Drone"
	desc = "A maintenance drone, a robot built to perform station repairs."
	...
	var/laws = \
	"1. Do not hinder the freedom or actions of the living and other silicons or attempt to intervene in their affairs except drones.\n"+\
	"2. Do not willingly damage the facility that housed your activation in any shape or form.\n"+\
	"3. Maintain, repair and improve the facility that housed your activation." //for derelict drones so they don't go to station.
	...
	"<span class='notify'>     - You can kill Syndrones and undo the damage they do as long as you witness them doing it and are sure a syndrone did it.</span>\n"+\
