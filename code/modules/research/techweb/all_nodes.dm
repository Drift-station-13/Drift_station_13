...
/datum/techweb_node/base
	...
	"rglass","plasteel","plastitanium","plasmaglass","plasmareinforcedglass","titaniumglass","plastitaniumglass","medkit_cabinet")
...
/datum/techweb_node/advance_surgerytools
	...
	design_ids = list("drapes", "laserscalpel", "mechanicalpinches", "searingtool", "shears")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
