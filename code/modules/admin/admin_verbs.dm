...
GLOBAL_LIST_INIT(admin_verbs_spawn, list(/datum/admins/proc/spawn_atom, /datum/admins/proc/spawn_cargo, /datum/admins/proc/spawn_human, /datum/admins/proc/spawn_objasmob, /client/proc/respawn_character))
