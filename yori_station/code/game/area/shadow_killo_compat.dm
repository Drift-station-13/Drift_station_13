/* Taken from Shadow station, zone if just here to load map */
...
/*
	Porting over this item for Kilo map.
	code from: code\modules\detectivework\footprints_and_rag.dm
	TODO: search for all "/obj/item/reagent_containers/glass/rag" in the shadow station code base & implment the features for the item.
*/
