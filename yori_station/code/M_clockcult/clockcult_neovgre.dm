/obj/mecha/combat/neovgre
	...
	icon = 'yori_station/icons/M_clockcult/neovgre.dmi'
	icon_state = "neovgre"
	max_integrity = 600 //This is THE ratvarian superweaon, its deployment is an investment
	armor = list("melee" = 65, "bullet" = 40, "laser" = 25, "energy" = 25, "bomb" = 60, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 100) //Its similar to the clockwork armour albeit with a few buffs becuase RATVARIAN SUPERWEAPON!!
	...
	leg_overload_coeff = 100 // smashy smash walls
	max_temperature = 40000

/obj/mecha/combat/neovgre/add_cell(obj/item/stock_parts/cell/C=null)
	if(C)
		C.forceMove(src)
		cell = C
		return
	cell = new /obj/item/stock_parts/cell/neovgre(src)

/obj/item/stock_parts/cell/neovgre
	name = "Neovgre power cell"
	desc = "A transdimensional power cell, powered by Ratvar himself."
...
/obj/mecha/combat/neovgre/GrantActions(mob/living/user, human_occupant = 0) //No Eject action for you sonny jim, your life for Ratvar!
	...
	overload_action.Grant(user, src) // smashy smash walls
...
/obj/mecha/combat/neovgre/RemoveActions(mob/living/user, human_occupant = 0)
	...
	overload_action.Remove(user) // smashy smash walls
...
/obj/item/mecha_parts/mecha_equipment/weapon/energy/laser/heavy/neovgre
	...
	fire_sound = "yori_station/sound/M_clockcult/neovgre_laser.ogg"
